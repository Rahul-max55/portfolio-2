        ...
        <div className=" w-6/12 h-80 flex justify-between items-center">
          <div className=" w-10/12 h-full flex justify-between items-start flex-col">
            ...
            <div className="flex space-x-4">
              <Link to="/about" className="flex px-5 py-3 items-center justify-center bg-yellow-500 transition-colors text-xl font-medium text-white space-x-2 rounded-full shadow-lg border-2 border-yellow-400 hover:bg-transparent">
                <CgProfile /> <span>MORE ABOUT ME </span>
              </Link>
              <Link to="/portfolio" className="flex px-5 py-3 items-center justify-center border-2 border-yellow-400 text-xl font-medium text-white space-x-2 rounded-full shadow-lg hover:bg-yellow-500">
                <AiFillProfile />
                <span>PORTFOLIO</span>
              </Link>
            </div>
